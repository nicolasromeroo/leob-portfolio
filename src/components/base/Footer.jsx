      ...
      <div className="container">
        <div className="footer-content">
          ...
          <div className="footer-links">
            ...
            <div className="link-group">
              ...
              <ul>
                <li>
                  <a href="#portfolio">Corporate</a>
                </li>
                <li>
                  <a href="#portfolio">Commercial</a>
                </li>
                <li>
                  <a href="#portfolio">Music Videos</a>
                </li>
                <li>
                  <a href="#portfolio">Documentary</a>
                </li>
              </ul>
            </div>
            ...
            <div className="link-group">
              ...
              <ul>
                <li>
                  <a href="mailto:hello@leobeditor.com">hello@leobeditor.com</a>
                </li>
                <li>
        ...
        <div className="footer-bottom">
          <div className="footer-copyright">
            <p>&copy; {currentYear} LEOB Video Editor. All rights reserved.</p>
          </div>
